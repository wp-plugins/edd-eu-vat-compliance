...
Tags: edd, easydigitaldownloads, vat, eu vat, vatmoss, vat moss, european vat, eu tax, european tax, iva, iva ue
...
Comply with EU VAT regulations for digital goods: Charge your customers the VAT rate according to their location and save the evidence required by EU Laws
...
1. If you choose so you can use GeoLite2 data created by MaxMind, a free geoip database available from http://www.maxmind.com. Activate this setting in EDD extension tab.
2. If the database is not present the admin can enable host.info as alternative method from EDD settings tab

You will need to choose of at least the above method from EDD settings tab.
